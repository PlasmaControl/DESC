...
class ObjectiveFunction(IOAble):
    ...
    def _set_derivatives(self):
        ...
        if self._deriv_mode == "blocked":
            ...
            self._jac_scaled = functools.partial(jac_, "jac_scaled")
            self._jac_scaled_error = functools.partial(jac_, "jac_scaled_error")
            self._jac_unscaled = functools.partial(jac_, "jac_unscaled")
