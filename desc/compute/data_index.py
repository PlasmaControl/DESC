...
data_index["d"] = {
    ...
    "fun": "compute_pressure_anisotropy",
    "dim": 1,
    "dependencies": {
        "params": ["d_lmn"],
        "transforms": {},
...
data_index["grad(d)"] = {
    ...
    "fun": "compute_force_error_anisotropic",
    "dim": 3,
    "dependencies": {
        "params": [],
        "transforms": {},
...
data_index["F_anisotropic"] = {
    "label": "F_{anisotropic}",
    "units": "N \\cdot m^{-3}",
    "units_long": "Newtons / cubic meters",
    "description": "Force residual",
    "fun": "compute_force_error_anisotropic",
    "dim": 3,
    "dependencies": {
        "params": [],
