...
eq1.save("run__ncsx_vac_out1.h5")
with open("run__ncsx_vac_out1.pkl", "wb+") as f:
    pickle.dump(out, f)
...
eq2.save("run__ncsx_vac_out2.h5")
with open("run__ncsx_vac_out2.pkl", "wb+") as f:
    pickle.dump(out, f)
...
eq2.save("run__ncsx_vac_out3.h5")
with open("run__ncsx_vac_out3.pkl", "wb+") as f:
    pickle.dump(out, f)
...
veq.save("run__ncsx_vac_outv.h5")
with open("run__ncsx_vac_outv.pkl", "wb+") as f:
    pickle.dump(out, f)
