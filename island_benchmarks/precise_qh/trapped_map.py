...
boozmn_filename = "wout_precise_QH_output.nc"

charge = ALPHA_PARTICLE_CHARGE
mass = ALPHA_PARTICLE_MASS
Ekin = 1e-3*FUSION_ALPHA_PARTICLE_ENERGY
...
for lam in lam_range:
    ...
    if verbose:
        poinc.plot_poincare(filename=f"trapped_map_{1/lam:.2f}.pdf")
        np.savez(
            f"poincare_data_Bcrit_{1/lam:.2f}.npz",
            s_all=poinc.s_all,
