...
def plot_fb_err(equil,domain='real',normalize='local',log=True,cmap='plasma',**kwargs):
    ...
    F_mag,p_mag = compute_F_magnitude(coord_der,cov_basis,con_basis,jacobian,B_field,J_field,cP,cI,Psi_lcfs,nodes)
...
def plot_comparison(equil0,equil1,label0='x0',label1='x1',**kwargs):
    ...
    Args:
        equil0 (dict): dictionary of first equilibrium solution quantities
        equil1 (dict): dictionary of second equilibrium solution quantities
