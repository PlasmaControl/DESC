...
def K_sour(p_M, p_N,
    ...
    for i in range(0,r):
        ...
        #omega_total_real += y[i] * jnp.real(omega_s1 + omega_s2 + omega_s3)
        #omega_total_imag += y[i] * jnp.imag(omega_s1 + omega_s2 + omega_s3)
...
def bn_res(p_M, p_N, 
    ...
    #                 y,
    #                 eq,
    #                 Bgrid,contour_data, contour_grid)
...
def B_contour(grid_cont,
    ...
    B_cont = _compute_magnetic_field_from_Current_Contour(grid_cont, 
                                                          K_cont,
