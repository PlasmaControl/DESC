...
class VariableSigma(_Objective):
    ...
    def build(self, use_jit=True, verbose=1):
        ...
        #surf_winding = (self._eq).surface.constant_offset_surface_mod(
    ...
    def compute(self, equil_params, surface_params=None, constants=None):
        ...
        cdata = compute_fun(
            ...
            self._curve_data_keys,
            params=curve_params,
            transforms=curve_transforms, #constants["curve_transforms"],
        ...
        B_ = self._field.compute_magnetic_field(
            ...
            basis="rpz",
            params=field_params,
            transforms=field_transforms,#constants["field_transforms"],
        )
        
        H1 = compute_fun(self._eq,
            ["H1"],
            params=equil_params,
            transforms=equil_transforms, #constants["surface_transforms"],
            profiles=equil_profiles,#constants["equil_profiles"],
            basis="xyz",
                        )["H1"]
