...
class Equilibrium(IOAble, Optimizable):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        errorif(
            (NFP_umbilic_factor is not None) and not isposint(NFP_umbilic_factor),
            ValueError,
    ...
    def NFP_umbilic_factor(self, NFP_umbilic_factor):
        assert isinstance(NFP_umbilic_factor, numbers.Real) and (
            NFP_umbilic_factor > 0
        ), (
            "NFP_umbilic_factor should be a"
            f" positive integer, got {type(NFP_umbilic_factor)}"
        )
