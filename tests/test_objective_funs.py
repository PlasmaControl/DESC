...
from desc.basis import PowerSeries, DoubleFourierSeries, FourierZernikeBasis, FourierSeries
...
class TestObjectiveFunctionFactory(unittest.TestCase):
    ...
    def test_obj_fxn_types(self):
        ...
        obj_fun = ObjectiveFunctionFactory.get_equil_obj_fun(errr_mode,
                                                             R0_transform=R0_transform, Z0_transform=R0_transform,
                                                             r_transform=r_transform, l_transform=l_transform,
                                                             R1_transform=RZ1_transform, Z1_transform=RZ1_transform,
                                                             p_transform=PI_transform, i_transform=PI_transform)
