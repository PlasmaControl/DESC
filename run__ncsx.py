...
eq1.save("run__ncsx_out1.h5")
with open("run__ncsx_out1.pkl", "wb+") as f:
    pickle.dump(out, f)
...
eq2.save("run__ncsx_out2.h5")
with open("run__ncsx_out2.pkl", "wb+") as f:
    pickle.dump(out, f)
...
eq2.save("run__ncsx_out3.h5")
with open("run__ncsx_out3.pkl", "wb+") as f:
    pickle.dump(out, f)
...
veq.save("run__ncsx_outv.h5")
with open("run__ncsx_outv.pkl", "wb+") as f:
    pickle.dump(out, f)
