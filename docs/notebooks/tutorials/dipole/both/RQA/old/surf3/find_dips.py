...
def B_sticks(p_M, p_N,
    ...
    def body_fun_(i, carry):
        ...
        b_stick_pol = stick(du_data["x"][i], # u-pos of first dipole
        ...
        b_stick_tor = stick(dr_data["x"][i], # u-pos of first dipole
        ...
        carry += y_pol * b_stick_pol + y_tor * b_stick_tor
        return carry

    b_sticks_total = fori_loop(0, r, body_fun_, jnp.zeros_like(pls_points) )
