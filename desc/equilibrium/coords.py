...
def _L_partial_sum(L, L_lmn):
    ...
    L : Transform
        FourierZernikeBasis
    L_lmn : jnp.ndarray
        FourierZernikeBasis basis coefficients.
    ...
    return L_m, jnp.fft.rfftfreq(grid.num_theta, 1 / grid.num_theta)


def _map_clebsch_coordinates_partial_sum(
    rho,
    alpha,
    zeta,
    iota,
