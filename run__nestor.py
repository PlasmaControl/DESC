...
eq1.save("run__nestor_out1.h5")
with open("run__nestor_out1.pkl", "wb+") as f:
    pickle.dump(out, f)
...
eq2.save("run__nestor_out2.h5")
with open("run__nestor_out2.pkl", "wb+") as f:
    pickle.dump(out, f)
...
veq.save("run__nestor_outv.h5")
with open("run__nestor_outv.pkl", "wb+") as f:
    pickle.dump(out, f)
