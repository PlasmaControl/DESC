...
for zeta in zeta_list:
    ...
    obj = ParticleTracer(eq=eq, output_time=time, initial_conditions=ini_cond, initial_parameters=ini_param, compute_option="optimization", tolerance=1e-7, deriv_mode="rev")
    obj.build()

    # Add to tuple
    objective_tuple = objective_tuple + (obj,)
...
ObjFunction = ObjectiveFunction(objective_tuple, deriv_mode="looped")
