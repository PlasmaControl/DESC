from movable_xpt import optimize_coils
from find_xpt import find_xpt, load, LinearGrid, np
...
optimize_coils(root_dir,**weights)


# Reoptimize the X-point (without distance target) to see where the actual best X-point is
