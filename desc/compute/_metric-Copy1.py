...
def _e_theta_x_e_zeta_t(params, transforms, profiles, data, **kwargs):
...
@register_compute_fun(
    name="|e_theta x e_zeta|_tt",
    label="\\partial_{\\theta \\theta}|\\mathbf{e}_{\\theta} \\times \\mathbf{e}_{\\zeta}|",
    units="m^{2}",
    units_long="square meters",
    description="2D Jacobian determinant for constant rho surface,"
    "derivative wrt poloidal angle",
...
def _e_theta_x_e_zeta_tt(params, transforms, profiles, data, **kwargs):
    data["|e_theta x e_zeta|_tt"] = ( 
        dot( cross(data["e_theta_tt"], data["e_zeta"]) + cross(data["e_theta_t"], data["e_zeta_t"])
            + cross(data["e_theta_t"], data["e_zeta_t"]) + cross(data["e_theta"], data["e_zeta_tt"]),
            cross(data["e_theta"], data["e_zeta"])
           ) / (data["|e_theta x e_zeta|"])
        
        + dot( cross(data["e_theta_t"], data["e_zeta"]) + cross(data["e_theta"], data["e_zeta_t"]),
              cross(data["e_theta_t"], data["e_zeta"]) + cross(data["e_theta"], data["e_zeta_t"])
             ) / (data["|e_theta x e_zeta|"])
...
@register_compute_fun(
    name="|e_theta x e_zeta|_tz",
    label="\\partial_{\\theta \\zeta}|\\mathbf{e}_{\\theta} \\times \\mathbf{e}_{\\zeta}|",
    units="m^{2}",
    units_long="square meters",
    description="2D Jacobian determinant for constant rho surface,"
    "derivative wrt poloidal angle",
    ...
    coordinates="rtz",
    data=["e_theta", "e_zeta", 
          "e_theta_t","e_theta_z", "e_zeta_t", "e_zeta_z",
          "e_theta_tz", "e_zeta_tz",
          "|e_theta x e_zeta|"],
    parameterization=[
        "desc.equilibrium.equilibrium.Equilibrium",
        "desc.geometry.core.Surface",
...
def _e_theta_x_e_zeta_tz(params, transforms, profiles, data, **kwargs):
    data["|e_theta x e_zeta|_tz"] = ( 
        dot( cross(data["e_theta_tz"], data["e_zeta"]) + cross(data["e_theta_t"], data["e_zeta_z"])
            + cross(data["e_theta_z"], data["e_zeta_t"]) + cross(data["e_theta"], data["e_zeta_tz"]),
            cross(data["e_theta"], data["e_zeta"])
           ) / (data["|e_theta x e_zeta|"])
        
        + dot( cross(data["e_theta_t"], data["e_zeta"]) + cross(data["e_theta"], data["e_zeta_t"]),
              cross(data["e_theta_z"], data["e_zeta"]) + cross(data["e_theta"], data["e_zeta_z"])
             ) / (data["|e_theta x e_zeta|"])
...
@register_compute_fun(
    name="|e_theta x e_zeta|_zz",
    label="\\partial_{\\zeta \\zeta}|\\mathbf{e}_{\\theta} \\times \\mathbf{e}_{\\zeta}|",
    units="m^{2}",
    units_long="square meters",
    description="2D Jacobian determinant for constant rho surface,"
    "derivative wrt toroidal angle",
...
def _e_theta_x_e_zeta_zz(params, transforms, profiles, data, **kwargs):
    data["|e_theta x e_zeta|_zz"] = ( 
        dot( cross(data["e_theta_zz"], data["e_zeta"]) + cross(data["e_theta_z"], data["e_zeta_z"]) 
            + cross(data["e_theta_z"], data["e_zeta_z"]) + cross(data["e_theta"], data["e_zeta_zz"]), 
            cross(data["e_theta"], data["e_zeta"])
           ) / (data["|e_theta x e_zeta|"])
        + dot( cross(data["e_theta_z"], data["e_zeta"]) + cross(data["e_theta"], data["e_zeta_z"]), 
              cross(data["e_theta_z"], data["e_zeta"]) + cross(data["e_theta"], data["e_zeta_z"])
           ) / (data["|e_theta x e_zeta|"])
        + dot( cross(data["e_theta_z"], data["e_zeta"]) + cross(data["e_theta"], data["e_zeta_z"]), 
              cross(data["e_theta"], data["e_zeta"])
