...
from desc.backend import desc_config, fori_loop, jnp, rfft2
...
def _contract_biot_savart(eval_data, source_data, weight):
    ...
    # Both sums are one contraction. The split adds error ~ eps |r| / |r - r'|,
